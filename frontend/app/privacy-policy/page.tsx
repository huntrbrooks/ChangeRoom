    ...
    <main className="min-h-screen bg-black text-white font-sans">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <h1 className="text-4xl font-bold text-cyan-300">Privacy Policy</h1>
        </div>
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-gray-300">
          <section>
            <h2 className="text-2xl font-bold mb-4 text-cyan-300">1. Introduction</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-cyan-300">2. Information We Collect</h2>
            
            <h3 className="text-xl font-semibold mb-3 text-cyan-400 mt-6">2.1 Information You Provide</h3>
            ...
            <h3 className="text-xl font-semibold mb-3 text-cyan-400 mt-6">2.2 Automatically Collected Information</h3>
            <p className="leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-cyan-300">3. How We Use Your Information</h2>
            <p className="leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-cyan-300">4. Image Processing and Storage</h2>
            <p className="leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-cyan-300">5. Information Sharing and Disclosure</h2>
            <p className="leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-cyan-300">6. Data Security</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-cyan-300">7. Cookies and Tracking Technologies</h2>
            <p className="leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-cyan-300">8. Your Rights and Choices</h2>
            <p className="leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-cyan-300">9. Children&apos;s Privacy</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-cyan-300">10. International Data Transfers</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-cyan-300">11. Data Retention</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-cyan-300">12. Changes to This Privacy Policy</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-cyan-300">13. Contact Us</h2>
            <p className="leading-relaxed">
