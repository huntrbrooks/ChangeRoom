      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="p-6 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-600">
                  Every result can be downloaded and shared instantly, so you can pitch, compare looks, and hand off a clean try-on without extra setup.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-3 text-gray-700 leading-relaxed">
              <p>
                ...
                - The prototype focuses on one fast flow: upload, generate, review, and shop.
              </p>
              <p>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed">
              Sign-in is required to upload and generate looks. We run a wake-up check on the try-on service, provide progress feedback while your look generates, and give you full control to download or share the result.
            </p>
          </section>
